...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
	            ...
	            <p><i class="icon-camera-retro"></i> Posted on <a href="<?php echo $link; ?>" target="_blank"><?php echo get_the_date ( 'M jS, Y g:ia' ); ?></a> by <a target="_blank" href="http://instagram.com/<?php echo $username; ?>">@<?php echo $username; ?></a></p>
