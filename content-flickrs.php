...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
	            ...
	            <?php } ?>
	                	...
	                	<p><i class="icon-camera"></i> <?php _e( 'Posted on', 'wparmchair' ); ?> <a href="<?php echo $link; ?>" target="_blank"><?php echo get_the_date ( 'M jS, Y g:ia' ); ?></a> <?php _e( 'by', 'wparmchair' ); ?> <?php echo $username; ?></p>
